...
void ForwardRenderer::BeginTwoPass()
{
	...
	//Deferred Data
	this->d3d11DeviceContext->PSSetShaderResources(1, 1, &dSRV);	//texture인데 그거 안된거
	this->d3d11DeviceContext->PSSetShaderResources(2, 1, &dSRV2);	//depth
	//Forward Data
	this->d3d11DeviceContext->PSSetShaderResources(3, 1, &fSRV[0]);	//texture
	this->d3d11DeviceContext->PSSetShaderResources(4, 1, &fSRV[1]);	//depth
